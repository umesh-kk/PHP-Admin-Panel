...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary">Musics List </h6>
    </div>
    <div class="card-body">
      <form name="userMasterForm" id="userMasterForm" method="post" action="<?php echo base_url();?>admin/musics">
        <div class="form-group row">
          ...
          <div class="col-sm-2 mb-2 mb-sm-0 float-right">
            <a class="btn btn-primary btn-user" href="<?php echo base_url();?>admin/musics/add">
              ADD
            </a>
          </div>
          <!-- <div class="col-sm-3">
        ...
        <table class="table table-bordered" id="dataTables" width="100%" cellspacing="0">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <?php
                if($val['audio_url'] != '' && $val['audio_url'] != null){ ?>
                <audio controls>
                  <source src="<?php echo $val['audio_url'];?>" type="audio/mp4">
              ...
              <td>
                <span class="actions" style="font-size:1.35rem;color:#f55050;padding:5px;">
                  <a href="<?php echo base_url();?>admin/musics/add/<?php echo $val['id']; ?>" >
...
<script>
  $(function() {
    $('.toggle-demo').bootstrapToggle().change(function() {
      ...
      $.ajax({
				  type: 'POST',
				  url:"<?php echo base_url(); ?>admin/musics/changeStatus",
				  data: {'id':id,'status':toggleVal},
				  success: function(resultData) { 
				    //window.location.href = "<?php echo base_url(); ?>admin/musics";
  ...
  function myFunction(id) {
    ...
    if (confirm("Are you sure you want to delete this music?") == true) {
        x = "Are you sure you want to delete this music?";
			$.ajax({
				  type: 'POST',
				  url:"<?php echo base_url(); ?>admin/musics/deleteUser",
				  data: {'id':id},
				  success: function(resultData) { 
				    window.location.href = "<?php echo base_url(); ?>admin/musics";
					//$("#myModals").html(resultData);
